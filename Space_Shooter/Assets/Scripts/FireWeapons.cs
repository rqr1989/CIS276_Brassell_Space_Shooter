...
public class FireWeapons : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Jump"))
            ...
            bool isBullet = true;
            CheckWeapon(projectile, isBullet);
                // Launches projectile
                projectile = Instantiate(projectile, transform);

                projectile.GetComponent<Rigidbody>().AddForce(Vector3.right* 5f, ForceMode.Impulse);
        ...
        void CheckWeapon(GameObject projectile, bool isBullet)
